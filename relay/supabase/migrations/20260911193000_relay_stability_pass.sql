...
-- Keep the contact surface live so open Contacts pages can refresh when
-- requests/connections change. Duplicate-object errors are ignored because
-- some environments may already publish these tables.
do $$
begin
  begin
