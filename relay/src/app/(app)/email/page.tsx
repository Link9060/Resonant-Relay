...
export default function EmailPage() {
  ...
  return <div className="mx-auto max-w-3xl px-4 py-8 md:px-6">
    ...
    <section className="mt-6 rounded-lg border border-border bg-surface-raised p-4">
      ...
      <p className="mt-2 text-xs leading-5 text-ink-muted">School email is okay here. Connecting it to Email or Calendar does not change the personal email you use to sign in to Relay.</p>
