...
export const DEVELOPMENT_VERSION = '1.0.6';
export const DEVELOPMENT_RELEASE_NAME = 'Planning Update';
export const APP_VERSION = IS_BETA ? DEVELOPMENT_VERSION : PRODUCTION_VERSION;
export const RELEASE_LABEL = IS_BETA ? `Beta ${APP_VERSION} · ${DEVELOPMENT_RELEASE_NAME}` : APP_VERSION;
export const APP_TITLE = IS_BETA ? `Relay · Beta ${APP_VERSION} · ${DEVELOPMENT_RELEASE_NAME}` : `Relay · ${APP_VERSION}`;
